...
## Compatibility Update — v1.1.3-hxi.1
...
|---|---|
| Mob casting alerts | Uses the correct action-packet target-count layout so cast-start messages can be identified again. |
| Combat and message log | Parses action results safely and does not mutate the action packet while only observing it. |
